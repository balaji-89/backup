...
import 'package:flutter_slidable/flutter_slidable.dart' as mySlide;
      ...
      return Scaffold(
          ...
          ListView.builder(
            ...
            itemBuilder: (context,position){
              ...
              ///
              return mySlide.Slidable(

                delegate: new mySlide.SlidableDrawerDelegate(),
                actionExtentRatio: 0.25,
                actions: <Widget>[
                  mySlide.IconSlideAction(
                    caption: 'Archive',
                    color: Colors.blue,
                    icon: Icons.archive,
                    onTap: () {
